...
@media(max-width:768px){.hamburger{display:flex!important}.sidebar{transform:translateX(-100%);transition:transform .25s;z-index:300;width:240px}.sidebar.open{transform:translateX(0)}.sidebar-overlay{display:block!important}html,body{overflow-x:hidden}.main{margin-left:0!important;width:100vw;min-width:0}.content{flex-direction:column;height:auto;overflow:visible}.pt-panel{width:100%!important;min-width:0;border-right:none;border-bottom:1px solid var(--border2);max-height:none;overflow:visible}.pt-list{max-height:none;overflow:visible}.pt-detail{padding:12px}.mobile-back-btn{display:flex!important}.pt-header{flex-direction:column;gap:10px}.pt-header-actions{justify-content:flex-start}.form-row{grid-template-columns:1fr}.stats-row{grid-template-columns:repeat(2,1fr)}.quick-actions{grid-template-columns:repeat(2,1fr)}.topbar{padding:0 12px;gap:8px}.tb-search{max-width:none;flex:1}.tb-right .badge-live{display:none}.ai-bar{gap:4px}.tabs-bar{font-size:11px}.pt-panel.hidden{display:none!important}}
