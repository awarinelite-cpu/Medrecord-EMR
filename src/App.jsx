...
:root{
  ...
  --accent:#1d6fa4;
  --accent2:#155f8e;
  --accent3:rgba(29,111,164,0.10);

  --blue:#1a4fa0;
  --purple:#3a3a9e;

  /* Text — dark, bold, visible on white */
  --t1:#0a1628;
  --t2:#1e3a5f;
  --t3:#4a6a8a;
  ...
  --border:rgba(29,111,164,0.20);
  --border2:rgba(10,28,78,0.10);
  --shadow:0 4px 20px rgba(10,28,78,0.10);
...
.sidebar{
  ...
  background:linear-gradient(180deg,#071540 0%,#0a1c4e 40%,#0d2460 100%);
...
.main{
  ...
  background:#F8FAFC;
  transition:transform .25s,margin-left .25s;
}
...
.topbar{
  ...
  padding:0 20px;position:sticky;top:0;z-index:50;gap:10px;
  box-shadow:0 2px 8px rgba(10,28,78,0.06);
}
.content{flex:1;display:flex;overflow:hidden;height:calc(100vh - 58px)}

/* ── Sidebar brand/logo ── */
.sb-logo{padding:16px 14px;border-bottom:1px solid rgba(255,255,255,0.10);flex-shrink:0}
.sb-logo-mark{display:flex;align-items:center;gap:9px}
.sb-icon{
  width:32px;height:32px;
  background:linear-gradient(135deg,#4da6e0,#2980b9);
...
.sb-sub{font-size:9px;color:rgba(180,210,255,0.6);letter-spacing:.5px;text-transform:uppercase}
...
.sb-avatar{
  ...
  background:linear-gradient(135deg,#4da6e0,#7aa8d4);
  display:flex;align-items:center;justify-content:center;
  font-size:12px;font-weight:900;flex-shrink:0;color:#fff;
}
.sb-uname{font-size:11px;font-weight:900;color:#ffffff;font-family:"Times New Roman",serif;}
.sb-urole{font-size:10px;color:#7db8e8;font-weight:700;}
...
.nav-btn{
  ...
  margin-bottom:2px;text-align:left;position:relative;
}
.nav-btn:hover{background:rgba(255,255,255,0.08);color:#fff;}
.nav-btn.active{
  background:rgba(77,166,224,0.18);
  color:#7dd3fc;
  border:1px solid rgba(77,166,224,0.28);
}
.nav-btn .ni{font-size:14px;width:17px;text-align:center}
.sb-footer{padding:10px 8px;border-top:1px solid rgba(255,255,255,0.08);flex-shrink:0}
...
.tb-sub{font-size:11px;color:#3d6080;margin-top:1px;font-weight:700;}
.tb-right{display:flex;align-items:center;gap:7px;flex-shrink:0}
.tb-search{
  display:flex;align-items:center;gap:7px;
  background:#f0f4fa;border:1.5px solid #dce6f5;
  border-radius:var(--r-sm);padding:6px 11px;
  flex:1;max-width:320px;position:relative;
}
.tb-search input{
  background:none;border:none;outline:none;
  color:#0a1628;font-size:13px;width:100%;
  font-family:"Times New Roman",serif;font-weight:700;
}
.tb-search input::placeholder{color:#8aa8cc;font-weight:400;}
.badge-live{
  display:inline-flex;align-items:center;gap:5px;
  padding:3px 9px;border-radius:20px;font-size:10px;font-weight:900;
  background:rgba(13,107,58,0.09);color:#0d6b3a;
  border:1px solid rgba(13,107,58,0.18);white-space:nowrap;
  font-family:"Times New Roman",serif;
}
.badge-dot{width:6px;height:6px;border-radius:50%;background:#0d6b3a;animation:pulse 2s infinite}
...
.btn-primary{background:linear-gradient(135deg,#0a1c4e,#1a3a7c);color:#fff;}
.btn-primary:hover{opacity:.88;transform:translateY(-1px)}
.btn-secondary{background:rgba(10,28,78,0.08);color:#0a1c4e;border:1px solid rgba(10,28,78,0.18);}
.btn-secondary:hover{background:rgba(10,28,78,0.14);}
.btn-danger{background:rgba(185,28,28,0.08);color:#b91c1c;border:1px solid rgba(185,28,28,0.18);}
.btn-danger:hover{background:rgba(185,28,28,0.14);}
.btn-ghost{background:rgba(10,28,78,0.05);color:#1e3a5f;border:1px solid #dce6f5;}
.btn-ghost:hover{background:rgba(10,28,78,0.10);color:#0a1628;}
...
.form-input,.form-select,.form-textarea{
  ...
  background:#f8fafc;border:1.5px solid #dce6f5;
  border-radius:var(--r-sm);color:#0a1628;
  font-size:13px;font-weight:700;outline:none;
  transition:border-color .15s;
  font-family:"Times New Roman",Times,serif;
  -webkit-appearance:none;appearance:none;
}
.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:#0a1c4e;outline:none;}
.form-input::placeholder,.form-textarea::placeholder{color:#8aa8cc;font-weight:400;}
.form-textarea{resize:vertical;min-height:80px;}
.form-select option{background:#fff;}
.form-row{display:grid;grid-template-columns:1fr 1fr;gap:11px}
.form-error{
  font-size:12px;color:#b91c1c;font-weight:700;margin-top:5px;
  padding:8px 11px;background:rgba(185,28,28,0.06);
  border-radius:var(--r-sm);border:1px solid rgba(185,28,28,0.18);
}
.form-success{
  font-size:12px;color:#0d6b3a;font-weight:700;margin-top:5px;
  padding:8px 11px;background:rgba(13,107,58,0.07);
...
.card{
  ...
  box-shadow:0 1px 6px rgba(10,28,78,0.05);
}

/* ── Patient panel ── */
.pt-panel{
  width:250px;background:#ffffff;
  border-right:2px solid #dce6f5;
  display:flex;flex-direction:column;flex-shrink:0;overflow:hidden;
}
.pt-panel-header{
  padding:12px 10px;border-bottom:2px solid #dce6f5;
  flex-shrink:0;background:#F8FAFC;
}
.pt-panel-title{
  font-size:13px;font-weight:900;margin-bottom:7px;
  color:#0a1628;font-family:"Times New Roman",serif;
}
.filter-tabs{display:flex;gap:3px;margin-bottom:7px}
.filter-tab{
  flex:1;padding:5px;border:none;border-radius:var(--r-sm);
  background:#eef2fa;color:#1e3a5f;
  font-size:10px;font-weight:900;cursor:pointer;
  font-family:"Times New Roman",serif;transition:all .15s;
}
.filter-tab.active{background:#0a1c4e;color:#ffffff;}
.pt-list{flex:1;overflow-y:auto;padding:5px}
.pt-card{
  padding:9px 10px;border-radius:var(--r-sm);
  cursor:pointer;border:1px solid transparent;
  transition:all .15s;margin-bottom:2px;background:#fff;
}
.pt-card:hover{background:#eef3ff;border-color:#dce6f5;}
.pt-card.active{background:#e8efff;border-color:#0a1c4e;}
.pt-name{font-size:12px;font-weight:900;margin-bottom:2px;color:#0a1628;font-family:"Times New Roman",serif;}
.pt-meta{font-size:10px;color:#1e3a5f;display:flex;gap:5px;align-items:center;flex-wrap:wrap;font-weight:700;}
.pt-detail{flex:1;overflow-y:auto;padding:18px;background:#F8FAFC;}
.empty-state{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:#4a6a8a;text-align:center;padding:40px;}
.empty-icon{font-size:46px;opacity:.25;margin-bottom:11px;}
.empty-text{font-size:15px;font-weight:900;color:#1e3a5f;margin-bottom:5px;font-family:"Times New Roman",serif;}
.empty-sub{font-size:12px;font-weight:700;color:#4a6a8a;}

/* ── Patient header ── */
.pt-header{
  background:#ffffff;
  border:1.5px solid #dce6f5;border-left:4px solid #0a1c4e;
  border-radius:var(--r-lg);
  padding:16px 20px;margin-bottom:12px;
  display:flex;align-items:flex-start;justify-content:space-between;gap:14px;
  box-shadow:0 2px 8px rgba(10,28,78,0.05);
}
.pt-header-info h2{
  font-family:"Times New Roman",Times,serif;
  font-size:19px;font-weight:900;color:#0a1628;
}
.pt-header-meta{font-size:11px;color:#1e3a5f;margin-top:3px;display:flex;gap:8px;flex-wrap:wrap;font-weight:700;}
.pt-header-actions{display:flex;gap:5px;flex-shrink:0;flex-wrap:wrap;justify-content:flex-end;}

/* ── AI bar ── */
.ai-bar{
  background:#eef3ff;border:1px solid #dce6f5;
  border-radius:var(--r);padding:9px 13px;margin-bottom:12px;
  display:flex;align-items:center;gap:6px;flex-wrap:wrap;
}
.ai-bar-label{font-size:11px;font-weight:900;color:#0a1c4e;margin-right:3px;white-space:nowrap;font-family:"Times New Roman",serif;}
.ai-btn{
  padding:4px 10px;border:1px solid #c0cfe8;border-radius:20px;
  background:#fff;color:#0a1c4e;
  font-size:11px;font-weight:900;cursor:pointer;
  font-family:"Times New Roman",serif;transition:all .15s;
}
.ai-btn:hover{background:#0a1c4e;color:#fff;}
...
.stat-card{
  background:#ffffff;border:1px solid #dce6f5;
  border-top:3px solid #0a1c4e;
  border-radius:var(--r);padding:11px 13px;
  box-shadow:0 1px 5px rgba(10,28,78,0.05);
}
.stat-icon{font-size:15px;margin-bottom:4px;}
.stat-label{font-size:9px;color:#1e3a5f;font-weight:900;text-transform:uppercase;letter-spacing:.5px;font-family:"Times New Roman",serif;}
.stat-value{font-family:var(--mono);font-size:17px;font-weight:700;color:#0a1c4e;margin:2px 0;}
.stat-unit{font-size:9px;color:#4a6a8a;font-weight:700;}
...
.quick-btn{
  ...
  font-size:11px;font-weight:900;color:#1e3a5f;
  font-family:"Times New Roman",serif;transition:all .15s;text-align:left;
}
.quick-btn:hover{background:#eef3ff;border-color:#0a1c4e;color:#0a1c4e;}

/* ── Tabs ── */
.tabs-bar{
  display:flex;gap:2px;
  background:#eef3ff;border:1.5px solid #dce6f5;
...
.tab-btn{
  ...
  font-size:11px;font-weight:900;cursor:pointer;
  font-family:"Times New Roman",serif;transition:all .15s;white-space:nowrap;
}
.tab-btn.active{background:#0a1c4e;color:#ffffff;}

/* ── Table ── */
.table-wrap{overflow-x:auto;border-radius:var(--r);border:1.5px solid #dce6f5;}
table{width:100%;border-collapse:collapse}
th{
  padding:9px 11px;text-align:left;
  font-size:10px;font-weight:900;color:#0a1c4e;
  text-transform:uppercase;letter-spacing:.6px;
  background:#eef3ff;border-bottom:2px solid #dce6f5;
...
.badge-active{background:rgba(13,107,58,0.10);color:#0d6b3a;}
.badge-discharged{background:rgba(185,28,28,0.08);color:#b91c1c;}
.badge-given{background:rgba(13,107,58,0.10);color:#0d6b3a;}
.badge-missed,.badge-refused,.badge-withheld{background:rgba(185,28,28,0.08);color:#b91c1c;}
.badge-held{background:rgba(138,92,0,0.10);color:#8a5c00;}
.badge-critical{background:rgba(185,28,28,0.10);color:#b91c1c;border:1px solid rgba(185,28,28,0.22);}
.badge-warning{background:rgba(138,92,0,0.10);color:#8a5c00;border:1px solid rgba(138,92,0,0.22);}
.badge-normal,.badge-High,.badge-Low{background:rgba(13,107,58,0.10);color:#0d6b3a;}

/* ── Modals ── */
.modal-overlay{
  position:fixed;inset:0;background:rgba(10,28,78,0.55);
  z-index:1000;display:flex;align-items:center;justify-content:center;
  padding:20px;backdrop-filter:blur(3px);
}
.modal{
  background:#ffffff;border:2px solid #dce6f5;
  border-radius:var(--r-lg);width:100%;max-width:520px;
  max-height:92vh;overflow-y:auto;position:relative;
  box-shadow:0 20px 60px rgba(10,28,78,0.18);
}
.modal-lg{max-width:680px}
.modal-xl{max-width:900px}
.modal-header{
  padding:15px 18px;border-bottom:2px solid #dce6f5;
  display:flex;align-items:center;justify-content:space-between;
...
.modal-close:hover{color:#0a1628;background:#eef3ff;}
.modal-body{padding:16px 18px;}
.modal-footer{padding:11px 18px;border-top:2px solid #dce6f5;display:flex;gap:7px;justify-content:flex-end;}

/* ── Login page ── */
.login-page{
  min-height:100vh;display:flex;align-items:center;justify-content:center;
  background:linear-gradient(135deg,#0a1c4e 0%,#0d2460 50%,#071540 100%);
  padding:20px;
}
.login-box{
  width:100%;max-width:400px;
  background:#ffffff;
  border:1px solid #dce6f5;border-radius:var(--r-lg);
  padding:36px 32px;
  box-shadow:0 30px 80px rgba(0,0,0,0.35);
  border-top:4px solid #0a1c4e;
  position:relative;overflow:hidden;
}
.login-logo{text-align:center;margin-bottom:24px;}
.login-icon{
  width:48px;height:48px;
  background:linear-gradient(135deg,#0a1c4e,#1a3a7c);
  border-radius:13px;display:flex;align-items:center;
  justify-content:center;font-size:21px;margin:0 auto 9px;
}
.login-title{
  font-family:"Times New Roman",Times,serif;
  font-size:21px;font-weight:900;color:#0a1628;
}
...
.tab-switch-btn{
  flex:1;padding:7px;border:none;border-radius:var(--r-sm);
  background:none;color:#3d6080;
  font-size:11px;font-weight:900;cursor:pointer;
  font-family:"Times New Roman",serif;transition:all .2s;
}
...
.info-card{
  background:#ffffff;border:1px solid #dce6f5;
  border-radius:var(--r-lg);padding:15px 17px;margin-bottom:11px;
  box-shadow:0 1px 4px rgba(10,28,78,0.05);
}
.info-card h4{
  font-size:11px;font-weight:900;color:#1e3a5f;
...
.profile-item label{font-size:10px;color:#4a6a8a;text-transform:uppercase;letter-spacing:.5px;display:block;margin-bottom:2px;font-weight:900;}
.profile-item span{font-size:13px;font-weight:900;color:#0a1628;}
...
.vital-chip label{font-size:9px;color:#1e3a5f;text-transform:uppercase;display:block;margin-bottom:2px;letter-spacing:.5px;font-weight:900;}
.vital-chip span{font-family:var(--mono);font-size:12px;font-weight:700;color:#0a1c4e;}

/* ── Fluid balance ── */
.fluid-balance{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin-bottom:11px}
.fluid-stat{
  background:#F8FAFC;border:1px solid #dce6f5;
  border-radius:var(--r-sm);padding:11px;text-align:center;
}
.fluid-stat label{font-size:10px;color:#1e3a5f;display:block;margin-bottom:4px;text-transform:uppercase;letter-spacing:.5px;font-weight:900;}
.fluid-stat span{font-family:var(--mono);font-size:16px;font-weight:700;color:#0a1c4e;}

/* ── AI chat ── */
.ai-chat-msg{padding:10px 13px;border-radius:12px;font-size:13px;line-height:1.6;max-width:86%;}
.ai-chat-msg.user{
  background:#eef3ff;border:1px solid #dce6f5;
  border-radius:12px 12px 4px 12px;margin-left:auto;color:#0a1628;
}
.ai-chat-msg.assistant{
  background:#fff;border:1.5px solid #dce6f5;
  border-radius:12px 12px 12px 4px;color:#0a1628;
}
.ai-spinner{display:inline-block;width:14px;height:14px;border:2px solid #dce6f5;border-top-color:#0a1c4e;border-radius:50%;animation:spin .7s linear infinite}
@keyframes spin{to{transform:rotate(360deg)}}

/* ── Toast ── */
.toast{
  position:fixed;bottom:22px;right:22px;
  background:#ffffff;border:1.5px solid #dce6f5;
  border-radius:var(--r);padding:10px 15px;
  font-size:13px;font-weight:900;color:#0a1628;
  box-shadow:0 8px 30px rgba(10,28,78,0.14);
  z-index:9999;transform:translateY(20px);opacity:0;
  transition:all .25s;pointer-events:none;max-width:300px;
  font-family:"Times New Roman",serif;
}
.toast.show{transform:translateY(0);opacity:1;}
.toast-success{border-color:rgba(13,107,58,0.3);color:#0d6b3a;}
.toast-error{border-color:rgba(185,28,28,0.3);color:#b91c1c;}
.toast-warning{border-color:rgba(138,92,0,0.3);color:#8a5c00;}
...
.alert-critical{background:rgba(185,28,28,0.07);border:1px solid rgba(185,28,28,0.20);color:#b91c1c;}
.alert-warning{background:rgba(138,92,0,0.07);border:1px solid rgba(138,92,0,0.20);color:#8a5c00;}
...
.pain-btn{
  ...
  color:#1e3a5f;font-size:12px;font-weight:900;cursor:pointer;
  font-family:var(--mono);transition:all .15s;
}
.pain-btn:hover{border-color:#0a1c4e;color:#0a1c4e;}
.pain-btn.selected{background:#0a1c4e;border-color:#0a1c4e;color:#fff;}

/* ── Ward overview ── */
.ward-overview{display:grid;grid-template-columns:repeat(auto-fill,minmax(270px,1fr));gap:13px;padding:18px;overflow-y:auto;flex:1;background:#F8FAFC;}
.ward-card{
  background:#ffffff;border:1px solid #dce6f5;
...
/* ── Notifications ── */
.notif-panel{
  position:fixed;top:58px;right:0;width:330px;
  height:calc(100vh - 58px);
  background:#ffffff;border-left:2px solid #dce6f5;
  z-index:200;display:flex;flex-direction:column;
  transform:translateX(100%);transition:transform .25s;
  box-shadow:-4px 0 20px rgba(10,28,78,0.08);
}
.notif-panel.open{transform:translateX(0)}
.notif-item{padding:11px 15px;border-bottom:1px solid #eef2f8;cursor:pointer;transition:background .15s;}
.notif-item:hover{background:#F8FAFC;}
.notif-item.unread{border-left:3px solid #0a1c4e;}
.notif-item.critical-item{border-left:3px solid #b91c1c;}
...
.search-dropdown{
  ...
  background:#ffffff;border:1.5px solid #dce6f5;
  border-radius:var(--r-sm);
  box-shadow:0 8px 30px rgba(10,28,78,0.12);
  z-index:200;max-height:300px;overflow-y:auto;
}
.search-result-item{padding:9px 13px;cursor:pointer;border-bottom:1px solid #eef2f8;transition:background .15s;}
...
.overall-dot{width:8px;height:8px;border-radius:50%;background:#dce6f5;flex-shrink:0;}
.overall-dot.on{background:#0d6b3a;box-shadow:0 0 6px rgba(13,107,58,0.5);animation:pulse 2s infinite;}
...
.ward-report-card.submitted{border-color:rgba(13,107,58,0.30);background:rgba(13,107,58,0.02);}
.ward-report-card.missing{border-color:rgba(138,92,0,0.25);background:rgba(138,92,0,0.02);}
.ward-report-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;}
.ward-report-name{font-weight:900;font-size:13px;color:#0a1628;font-family:"Times New Roman",serif;}
.ward-report-meta{font-size:11px;color:#1e3a5f;margin-top:2px;font-weight:700;}
.ward-report-body{
  font-size:12px;color:#0a1628;line-height:1.6;
  white-space:pre-wrap;background:#F8FAFC;
  border-radius:var(--r-sm);padding:10px 12px;margin-top:8px;
  border:1px solid #dce6f5;font-weight:700;
}

/* ── Collation / Archive ── */
.collation-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:12px;margin-bottom:20px;}
.archive-card{background:#ffffff;border:1px solid #dce6f5;border-radius:var(--r);padding:14px 16px;margin-bottom:10px;}
.archive-header{display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:10px;gap:10px;}
.archive-title{font-family:"Times New Roman",Times,serif;font-size:14px;font-weight:900;color:#0a1628;}
.archive-meta{font-size:11px;color:#1e3a5f;margin-top:2px;font-weight:700;}
.archive-note{
  background:#F8FAFC;border:1px solid #dce6f5;
...
.section-title{font-family:"Times New Roman",Times,serif;font-size:16px;font-weight:900;color:#0a1628;margin-bottom:4px;}
.section-sub{font-size:12px;color:#1e3a5f;margin-bottom:16px;font-weight:700;}
.all-wards-header{
  background:#ffffff;border:1.5px solid #dce6f5;
  border-left:4px solid #0a1c4e;
  border-radius:var(--r-lg);padding:16px 20px;margin-bottom:18px;
  display:flex;align-items:flex-start;justify-content:space-between;gap:14px;flex-wrap:wrap;
}
.ward-block{background:#ffffff;border:1px solid #dce6f5;border-radius:var(--r-lg);margin-bottom:14px;overflow:hidden;}
.ward-block-header{
  padding:13px 16px;border-bottom:2px solid #dce6f5;
  display:flex;align-items:center;justify-content:space-between;
  background:#f0f4fa;
}
.ward-block-title{font-weight:900;font-size:14px;display:flex;align-items:center;gap:8px;color:#0a1628;font-family:"Times New Roman",serif;}
.ward-block-body{padding:14px 16px;background:#fff;}
.shift-report-item{
  padding:10px 12px;background:#F8FAFC;
  border-radius:var(--r-sm);margin-bottom:8px;
  border-left:3px solid #0a1c4e;
}
...
.shift-report-text{font-size:12px;color:#0a1628;line-height:1.65;white-space:pre-wrap;font-weight:700;}
.ward-empty{padding:14px;font-size:12px;color:#4a6a8a;font-style:italic;text-align:center;font-weight:700;}
...
::-webkit-scrollbar-thumb{background:#c0cfe8;border-radius:3px}
`;
